...
Write-Host ""
Write-Host "Receipts and grocery in-stock alerts text the customer when the modem is plugged in."
Write-Host "If the modem is missing, the UI shows failed. Retry from Admin, Messages after it is plugged in."
